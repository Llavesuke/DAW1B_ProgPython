...
El algoritmo pide tus frutas preferidas y sigue leyendo frutas hasta que se introduce un valor vacío. Entonces escribe la lista de frutas favoritas. Si no se
introduce ninguna fruta muestra un mensaje indicando que no le gustan las frutas.
